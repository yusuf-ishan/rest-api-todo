...
declare const ASTUtils: {
    ...
    getFunctionAncestor(context: Readonly<RuleContext<string, ReadonlyArray<unknown>>>): TSESTree.ArrowFunctionExpression | TSESTree.FunctionDeclarationWithOptionalName | TSESTree.FunctionExpression | undefined;
